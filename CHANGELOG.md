...
### Changed
- feat: scan Tailscale network for other Grima nodes and display them in the UI

## [0.8.9] - 2026-09-07

### Changed
- feat: add hardware temperature measurements for both Linux and Windows hosts
...
### Changed
- Handle WSL environment edge cases by explicitly noting Wi-Fi scanning limitations in the UI instead of falling back to hardcoded Wi-Fi states

## [0.8.5] - 2026-09-07

### Changed
- Refactor scanner.js to dynamically detect local hostname and network interfaces instead of hardcoding Wyse and Mercusys

## [0.8.4] - 2026-09-07

### Changed
- Refactor Shelly configuration to use config.json for multi-device support and disable by default
